...
(function ($, undef) {
	...
	function classToggleDisabled($tag, el, options) {
                ...
                // The following two if-statements are for a bug/whatever
                // without unifrom, the options isn't passed, and $el isn't
                // a jQuery object, thus lacking the .is()
                if (typeof options === 'undefined') {
                    options = $.uniform.defaults;
                }
